...
class Application(Gtk.Application):
    ...
    def do_activate(self):
        ...
        if launch_dir == "/usr/bin":
            modules_path = "/usr/share/com.github.malothebault.tournoi/tournoi"
        else:
            modules_path = "/app/bin/tournoi"
        ...
        self.settings = Gio.Settings(schema_id="com.github.malothebault.tournoi")
